...
==========================================================================
                       ...
                       CentOS  OpenVPN-2.3.14 云免服务器
                        Powered Qq:283294820 2015-2016
                               All Rights Reserved                  
...
rpm -ivh http://7xs2gz.dl1.z0.glb.clouddn.com/64epel-release-5-4.noarch.rpm
else
...
if [ $version == "6" ];then
if [ $(getconf LONG_BIT) = '64' ] ; then
rpm -ivh http://7xs2gz.dl1.z0.glb.clouddn.com/epel-release-6-8.noarch.rpm
else
...
cd /etc/openvpn/
rm -rf ./server.conf
wget http://7xs2gz.dl1.z0.glb.clouddn.com/server.tar.gz
...
echo "获取共享转发端口..."
sqip=`wget http://666.kfj.cc/ips/ -O - -q ; echo`
# OpenVPN Installing ****************************************************************************
cd /etc/openvpn/
